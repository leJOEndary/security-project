...
include 'core/init.php';
  if ($getFromUser->loggedIn()) {
	$user_id= $_SESSION['user_id'];
	$userData=$getFromUser->userData($user_id);
}
else header("Location: index.php"); //user is not authenticated 

 


// posting a tweet in our news feed
if(isset($_POST['tweet'])){
	...
	if(!empty($status) or !empty($_FILES['file']['name'][0])){
        ...
        $getFromUser->create('tweets',array('status'=>$status,'tweetBy'=>$user_id,'tweetImage'=>$tweetImage,'postedOn'=>date('Y-m-d H:i:s'),'privateTweet'=>$boolean));
		...
		$error="Write or choose image to Tweet";
	...
	<div class="nav">
		...
		<div class="nav-right">
			<ul>
				...
				<li class="hover"><label class="drop-label" for="drop-wrap1"><img src="
					<?php echo $userData->profileImage;?>" style="height: 40px;"/></label>
				<input type="checkbox" id="drop-wrap1">
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo $userData->username;?>"> 
		...
		<div class="info-box">
			<div class="info-inner">
				<div class="info-in-head">
					<!-- PROFILE-COVER-IMAGE -->
					<img src="<?php echo $userData->profileCover;?>"/>
				</div><!-- info in head end -->
				<div class="info-in-body">
					<div class="in-b-box">
						<div class="in-b-img">
						<!-- PROFILE-IMAGE -->
							<img src="<?php echo $userData->profileImage;?>"/>
						</div>
					</div><!--  in b box end-->
					<div class="info-body-name">
						<div class="in-b-name">
							<div><a href="<?php echo $userData->username; ?>">
								<?php echo $userData->screenName;?></a></div>
							<span><small><a href="<?php echo $userData->username; ?>">
								<?php echo $userData->username;?></a></small></span>
						</div><!-- in b name end-->
				...
				<div class="info-in-footer">
					<div class="number-wrapper">
						...
						<div class="num-box">
							...
							<div class="num-body">
								<span class="count-following"><?php echo $userData->following;?></span>
							</div>
						</div>
						<div class="num-box">
							<div class="num-head">
							...
							<div class="num-body">
								<span class="count-followers"><?php echo $userData->followers;?></span>
							</div>
						</div>	
					</div><!-- mumber wrapper-->
				</div><!-- info in footer -->
		...
		<div class="in-center">
			<div class="in-center-wrap">
				...
				<!--Tweet SHOW WRAPPER-->
				 <div class="tweets">
 				  	<!--TWEETS HERE-->
 				  	<?php $getFromTweet->tweetshome($user_id); ?>
