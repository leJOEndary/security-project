<?php 
	...
	if(isset($_POST['deleteTweet']) && !empty($_POST['deleteTweet'])){
		...
		$getFromTweet->delete('tweets',array('tweetID'=>$tweet_id,'tweetBy'=>$user_id));
					          ...
					          <div class="retweet-popup-comment-wrap">
					             ...
					             <div class="retweet-popup-comment-right-wrap">
					               <div class="retweet-popup-comment-headline">
					                <a><?php echo $tweet->profileImage;?> </a><span>‏@<?php echo BASE_URL.$tweet->username.' '.$tweet->postedOn;?></span>
					               </div>
