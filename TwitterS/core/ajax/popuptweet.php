						...
						<div class="tweet-show-popup-inner">
							...
							<div class="tweet-show-popup-tweet-wrap">
								<div class="tweet-show-popup-tweet">
									<?php echo $getFromTweet->getTweetLinks($tweet->status) ;?>
								</div>
					 	...
					 	<div class="tweet-show-popup-footer-input-wrap">
							<div class="tweet-show-popup-footer-input-inner">
								...
								<div class="tweet-show-popup-footer-input-right">
									<input id="commentField" data-tweet="<?php echo $tweet->tweetID; ?>" type="text" name="comment"  placeholder="Reply to @<?php echo $tweet->username; ?>">
								</div>
							</div>
													...
													<div class="tweet-show-popup-comment-head-right">
													 	...
													 	<div class="tweet-show-popup-footer-menu">
															<ul>
																...
																<a href="#" class="more"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a>
																<ul> 
																  <li><label class="deleteComment" data-tweet="'.$tweet->tweetID.'" data-comment="'.$comment->commentID.'">Delete Comment</label></li>s
																</ul>
																</li>' : '').' 
															</ul>
														</div>
