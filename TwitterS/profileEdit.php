...
if(isset($_POST['screenName'])){
	if(!empty($_POST['screenName'])){
		...
		if(strlen($screenName)>20){
			...
			$getFromUser->update('users',$user_id,array('screenName'=>$screenName,'bio'=>$bio,'country'=>$country,'website'=>$website));
			header('Location: BASE_URL'.$userData->username);
		}
	}else{$error="Name field can't be blink";}
}
	...
	<div class="nav">
		...
		<div class="nav-right">
			<ul>
				...
				<li class="hover"><label class="drop-label" for="drop-wrap1"><img src="<?php echo $userData->profileImage;?>"  style="height: 40px;"/></label>
				<input type="checkbox" id="drop-wrap1">
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo $userData->username;?>"><?php echo $userData->username ;?></a></li>
...
<div class="profile-nav">
	<div class="profile-navigation">
		...
		<div class="edit-button">
			<span>
				<button class="f-btn" type="button" onclick="window.Location.href='<?php echo $userData->username; ?>'" value="Cancel">Cancel</button>
			</span>
			<span>
			  ...
			  <!-- img upload end-->
				...
				<div class="profile-name-wrap">
					...
					<div class="profile-name">
						<input type="text" name="screenName" value="<?php echo $userData->screenName;?>"/>
					</div>
				...
				<div class="profile-bio-wrap">
					<div class="profile-bio-inner">
						<textarea class="status" name="bio"><?php echo $userData->bio ;?></textarea>
						<div class="hash-box">
					 		<ul>
					 		</ul>
					 	</div>
						...
						<ul>
							<li>
								<div class="profile-ex-location">
									<input id="cn" type="text" name="country" placeholder="Country" value="<?php echo $userData->country;?>" />
								</div>
							</li>
							<li>
								<div class="profile-ex-location">
									<input type="text" name="website" placeholder="Website" value="<?php echo $userData->website;?>"/>
								</div>
							</li>
								 <?php if(isset($error)){
